...
export function ReactComponentController({ currentConfig, provState }: { currentConfig: ReactComponent; provState?: unknown }) {
  ...
  useEffect(() => {
    if (currentConfig.parameters && currentConfig.parameters && typeof currentConfig.parameters.taskid === 'string') {
      // console.log(currentConfig.parameters[currentConfig.parameters.taskid]);
    }
